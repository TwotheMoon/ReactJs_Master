...
import { getAiringTV, getTopRatedTV, getTV, IGetMoviesResult } from "../api";
        ...
        <Wrapper>{isLoading ? (
            ...
            <>
                ...
                <SliderWrap onClick={() => setClickSlider(1)}>
                    <TvSliders data={data} title="최신 Tv 시리즈!" sliderNum={1} clickSlider={clickSlider} />
                </SliderWrap>
                ...
                <SliderWrap onClick={() => setClickSlider(3)}>
                    <TvSliders data={airing} title="오늘 바로 방송해요!" sliderNum={3} clickSlider={clickSlider} />
                </SliderWrap>
            </>
        )
        }
